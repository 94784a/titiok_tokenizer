...
class LPIPS(nn.Module):
    ...
    def __init__(self, use_dropout=True,vgg_ckpt_path="/high_perf_store2/users/yaoziyang/DinoTok/related_public_checkpoints/vgg16-397923afv2.pth",checkpoint="/high_perf_store2/users/yaoziyang/DinoTok/related_public_checkpoints/vgg.pth"):
        super().__init__()
        ...
        self.net = vgg16(pretrained=True, requires_grad=False,ckpt_path=vgg_ckpt_path)#
